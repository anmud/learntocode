...
![performance-now](./performance-now.png)
...
3. When it finishes it's removed from the call stack
...
10. Invoking the `numbers` function will invoke another `console.log('123'), 
...
![event-loop-12](./event-loop-12.png)
